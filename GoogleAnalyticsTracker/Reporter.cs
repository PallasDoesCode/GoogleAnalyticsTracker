...
namespace GoogleAnalyticsTracker
{
    public class Reporter : IReporter
    {
        ...
        public Reporter(string trackingID, string clientID)
        {
            this.googleTrackingID = trackingID;
            this.googleClientID = clientID;
        }

        public string GetEventTrackingUrl(string category, string action, string label, int? value = null)
        {
            ...
            return GetRequestUrl(values);
        }

        public string GetPageviewTrackingUrl(string hostname, string page, string title)
        {
            var values = DefaultValues;
        ...
        public string GetTransactionTrackingUrl(string id, string affiliation, string revenue, string shipping, string tax, string code)
        {
        ...
        public string GetTransactionItemTrackingUrl(string id, string name, string price, string quantity, string sku, string variation, string code)
        {
            if (string.IsNullOrEmpty(id)) throw new ArgumentNullException("id");
        ...
        public string GetSocialTrackingUrl(string action, string network, string target)
        {
            if (string.IsNullOrEmpty(action)) throw new ArgumentNullException("action");
        ...
        public string GetExceptionTrackingUrl(string description, string isFatal)
        {
            var values = DefaultValues;
        ...
        public string GetUserTimingTrackingUrl(string category, string variable, string time, string label, string dns, string pageDLtime, string redirectTime, string tcpConnectTime, string serverResponseTime)
        {
            var values = DefaultValues;
        ...
        public string GetScreenviewTrackingUrl(string name, string version, string id, string installerId, string description)
        {
            var values = DefaultValues;
        ...
        private string GetRequestUrl(Dictionary<string, string> values)
        {
            var url = values
        ...
        public void TrackAsync(string url)
        {
